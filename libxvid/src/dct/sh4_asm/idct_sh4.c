/* sh4_idct for libxvidcore by OVERRiDE aka PH3NOM 2010
 *
 * Based On:
 *
 * idct for sh4
...
#define W1      1.38703984532214752434  /* sqrt(2)*cos(1*pi/16) */
#define W2      1.30656296487637657577  /* sqrt(2)*cos(2*pi/16) */
#define W3      1.17587560241935884520  /* sqrt(2)*cos(3*pi/16) */
#define W4      1.00000000000000000000  /* sqrt(2)*cos(4*pi/16) */
#define W5      0.78569495838710234903  /* sqrt(2)*cos(5*pi/16) */
#define W6      0.54119610014619712324  /* sqrt(2)*cos(6*pi/16) */
#define W7      0.27589937928294311353  /* sqrt(2)*cos(7*pi/16) */
